    ...
    <div class="container mt-5">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form @submit.prevent="updateProduct">
                ...
                <div class="mb-3">
                  <label for="editName" class="form-label">Tên phiếu xuất</label>
                  <input
                    type="text"
                    id="editName"
                    class="form-control"
      ...
      >
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="addProductModalLabel">Thêm phiếu xuất</h5>
              <button
                type="button"
                class="btn-close"
                aria-label="Close"
            ...
            <div class="modal-body">
              <form @submit.prevent="addProduct">
                ...
                <div class="mb-3">
                  <label for="newName" class="form-label">Tên phiếu xuất</label>
                  <input
                    type="text"
                    id="newName"
                    class="form-control"
